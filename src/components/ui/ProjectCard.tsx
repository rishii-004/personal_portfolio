  ...
  if (isExpandable && onOpenModal) {
    return (
      ...
      >
        ...
        <h3 className="mt-3 text-lg font-semibold tracking-tight text-zinc-900 dark:text-zinc-50 group-hover:text-sky-600 dark:group-hover:text-amber-300 transition-colors duration-200">
          {project.title}
        </h3>
