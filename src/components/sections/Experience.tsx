      ...
      <div className="mt-8 relative border-l border-zinc-200/60 dark:border-zinc-800/60 ml-3.5 space-y-10">
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <span className="absolute left-0 top-1.5 -translate-x-1/2 flex h-7 w-7 items-center justify-center rounded-full border border-zinc-200 bg-white shadow-sm transition-colors duration-300 group-hover:border-orange-500 dark:border-zinc-800 dark:bg-zinc-950 dark:group-hover:border-orange-400">
              <Briefcase className="h-3 w-3 text-zinc-400 dark:text-zinc-500 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors" />
            </span>
