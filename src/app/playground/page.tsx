...
export default function PlaygroundPage() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-12">
        <h2 className="text-xs font-mono font-bold uppercase tracking-wider text-right mb-6 border-b border-zinc-200/40 dark:border-zinc-800/40 pb-3 bg-gradient-to-l from-sky-500 via-zinc-400 to-zinc-400 bg-clip-text text-transparent dark:from-amber-300 dark:via-zinc-500 dark:to-zinc-500">
          Flagship Projects
        </h2>
